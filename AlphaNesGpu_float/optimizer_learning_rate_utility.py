...
def build_learning_rate(param,ne,nb,buffer_stream_tr,name,num_call):
    if param[0]=='expdec':
       ...
       if num_call==0:
           ...
           print("STAF: ",name," final learning rate set to",final_learning_rate,sep=' ',end='\n')
       lr_built=optsch.ExponentialDecay(initial_learning_rate,1,(final_learning_rate/initial_learning_rate)**(1/tf),
        ...
        if num_call==0:
            ...
            print("STAF: ",name," initial learning rate set to",initial_learning_rate,sep=' ',end='\n')
            print("STAF: ",name," first decay steps set to",first_decay_steps,sep=' ',end='\n')
        ...
        sys.exit("STAF: learning rate can be expdec or cosann.")
    return lr_built
...
def build_optimizer(param,lr_built,num_call):
    if param[0]=='adam':
       ...
       if num_call==0:
           print("STAF: The optimizer is Adam.",sep=' ',end='\n')
           print("STAF: epsilon is set to ",epsilon,sep=' ',end='\n')
         ...
         if num_call==0:
             print("STAF: The optimizer is SGD.",sep=' ',end='\n')
             print("STAF: momentum is set to ",momentum,sep=' ',end='\n')
    else:
        sys.exit("STAF: optimizer can be only adam or sgd.")
