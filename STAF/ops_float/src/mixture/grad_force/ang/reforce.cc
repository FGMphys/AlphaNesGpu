...
void set_tensor_to_zero_float(real* tensor,int dim);
...
//   gradnet_3b_shape.AddDim (1);
    ...
    OP_REQUIRES_OK(context, context->allocate_output(0, gradnet_3b_shape,
                                                     &gradnet_3b_T));
    set_tensor_to_zero_float(gradnet_3b_T->flat<real>().data(),dimbat*Nlocal*num_finger);
    ...
    set_tensor_to_zero_float(grad_alpha3b_T->flat<real>().data(),dimnow);
    ...
    OP_REQUIRES_OK(context, context->allocate_output(2, grad_emb3b_shape,
                                                     &grad_emb3b_T));
    set_tensor_to_zero_float(grad_emb3b_T->flat<real>().data(),nt_couple*num_finger);
