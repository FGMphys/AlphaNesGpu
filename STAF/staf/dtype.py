...
def set_precision(
    ...
    *,
    ...
    try:
        ...
        # Package lives at STAF/staf/; sibling of staf_paths.py is STAF home.
        staf_home = Path(__file__).resolve().parents[1]
        if staf_home.is_dir() and str(staf_home) not in sys.path:
            sys.path.insert(0, str(staf_home))
