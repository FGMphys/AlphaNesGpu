...
energy=np.loadtxt("energy.dat",dtype='float64')
nf=energy.shape[0]
...
force=np.loadtxt("force.dat",dtype='float64')
...
pos=np.loadtxt("pos.dat",dtype='float64')
...
box=np.loadtxt("box.dat",dtype='float64')
