...
__global__ void gradforce_tripl_kernel(const real*  prevgrad_T_d,const real*  netderiv_T,
                                       ...
                                       const real* type_emb3b,const int* map_color_interaction,
                                       const int* actual_type_p,
                                       const int *num_triplets,const real* smooth_a_T_l,
                                       const int* color_type_map,const int* map_intra,real* gradnet_3b_T_d,
...
__global__ void gradforce_tripl_virial_kernel(const real*  prevgrad_T_d,const real* prevgrad_virial,
                                       ...
                                       const int* actual_type_p,
                                       const int *num_triplets,const real* smooth_a_T_l,
                                       const int* color_type_map,const int* map_intra,
...
void gradforce_tripl_virial_Launcher(const real*  prevgrad_T_d,const real* prevgrad_virial,
    ...
    TF_CHECK_OK(::tensorflow::GpuLaunchKernel(gradforce_tripl_virial_kernel,dimGrid,
                dimBlock, BLOCK_DIM*sizeof(real4), nullptr,
