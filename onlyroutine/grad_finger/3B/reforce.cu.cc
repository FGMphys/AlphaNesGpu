...
/*
        atomicAdd((float*)&next_emb3b_grad[sum*nsmooth_a+a1],prevgradel*Tjy*btjy*(a1dya2dj+a1dja2dy)/2.f);

        atomicAdd((float*)&next_alpha3b_grad[sum*nsmooth_a*3+a1*3+0],prevgradel*chtjy_par*(a1dja2dy*dj+a1dya2dj*dy)*btjy*Tjy/2.f);
        atomicAdd((float*)&next_alpha3b_grad[sum*nsmooth_a*3+a1*3+1],prevgradel*chtjy_par*(a1dja2dy*dy+a1dya2dj*dj)*btjy*Tjy/2.f);
        atomicAdd((float*)&next_alpha3b_grad[sum*nsmooth_a*3+a1*3+2],prevgradel*chtjy_par*(a1dja2dy+a1dya2dj)*btjy*Tjy*Tjy/2.f);
     */
	}
     __syncthreads();
